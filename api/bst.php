...
function main($group, $type, $code, &$play_url)
{
    ...
    for ($i = 1; $i <= 10; $i++) {
        foreach (hosts_get() as $host) {
            $u = intf_get($host, $group, $type, $code);
...
{
    $f = 'http://%s/ps/OttService/Auth?UserID=%s&UserToken=%s&TVID=$$%s&UserGroup=$TerOut_%d&ItemType=%d&ItemCode=%s';
    $r = sprintf($f, $host, user_get_id(), user_get_token(), tvid_get(), $group, $type, $code);
    return $r;
}
...
CCTV-3HD,bst.php?g=14&t=2&c=Umai:CHAN/1369028@BESTV.SMG.SMG
CCTV-4,bst.php?g=1&t=2&c=Umai:CHAN/1349@BESTV.SMG.SMG
CCTV-5HD,bst.php?g=14&t=2&c=Umai:CHAN/1369029@BESTV.SMG.SMG
CCTV-5+HD,bst.php?g=14&t=2&c=Umai:CHAN/6000068@BESTV.SMG.SMG
CCTV-6HD,bst.php?g=14&t=2&c=Umai:CHAN/1369030@BESTV.SMG.SMG
CCTV-7,bst.php?g=1&t=2&c=Umai:CHAN/1352@BESTV.SMG.SMG
CCTV-8HD,bst.php?g=14&t=2&c=Umai:CHAN/1369033@BESTV.SMG.SMG
CCTV-9HD,bst.php?g=14&t=2&c=Umai:CHAN/5000039@BESTV.SMG.SMG
...
CCTV-16HD,bst.php?g=14&t=2&c=Umai:CHAN/6000061@BESTV.SMG.SMG
CCTV-17HD,bst.php?g=14&t=2&c=Umai:CHAN/5000041@BESTV.SMG.SMG

卫视,#genre#
安徽卫视HD,bst.php?g=1&t=2&c=Umai:CHAN/3540416@BESTV.SMG.SMG
北京卫视HD,bst.php?g=14&t=2&c=Umai:CHAN/181361@BESTV.SMG.SMG
